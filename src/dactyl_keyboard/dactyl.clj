...
(defn right-wall [border]
  (union 
    ...
    (wall-brace'        (partial key-place' border lastcol 2)  0  0 upper-fat-web-post-br-lower true (partial key-place' border (dec lastcol) 3)  1  -1 web-post-tr false  border)
