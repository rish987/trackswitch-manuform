...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MOUSE] = LAYOUT_5x6_right(
     ...
     _______,_______,_______,_______,_______,                        _______,_______,_______,SNIPING,MLOCK  ,
     _______,_______,_______,_______,                                _______,KC_BTN1,KC_BTN2,TRKPNT ,DRGSCRL,
     _______,_______,KC_LSFT,_______,_______,                                _______,_______ 
  ),
  [_ARROW] = LAYOUT_5x6_right(
     KC_F1  ,KC_F2  ,KC_F3  ,KC_F4  ,KC_F5  ,                        KC_F6  ,KC_F7  ,KC_F8  ,KC_F9  ,KC_F10 ,
     _______,_______,_______,_______,_______,                        KC_LEFT,KC_DOWN,KC_UP  ,KC_RGHT,_______,
     _______,_______,_______,_______,                                _______,KC_TAB ,KC_F11 ,KC_F12 ,_______,
